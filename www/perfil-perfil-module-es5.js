...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["perfil-perfil-module"], {
  ...
  function srcAppPagesPerfilPerfilPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function PerfilPage(fb, apiService, loadingController, ruta, alertController, webView, camera, service, utilities) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return this.apiService.actualizarPerfil(this.form.value);

                  case 4:
                    data = _context2.sent;

                    if (data) {
                      this.loadingController.dismiss(); // this.changepass()
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    _context3.next = 4;
                    return this.apiService.cambiarPassword(this.formpass.value);
                  ...
                  case 3:
                    ...
                    this.camera.getPicture(options).then(function (imageData) {
                      if (index == 1) {
                        ...
                        _this2.form.controls.avatar.setValue(_this2.imgSelected);

                        console.log("imagen", _this2.imgSelected);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], src_app_services_api_fitech_service__WEBPACK_IMPORTED_MODULE_2__["ApiFitechService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], _ionic_native_ionic_webview_ngx__WEBPACK_IMPORTED_MODULE_6__["WebView"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_7__["Camera"], src_app_services_api_fitech_service__WEBPACK_IMPORTED_MODULE_2__["ApiFitechService"], src_app_services_mensajes_service__WEBPACK_IMPORTED_MODULE_5__["MensajesService"]])], PerfilPage);
    /***/
  }
}]);
