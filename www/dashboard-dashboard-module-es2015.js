...
let DashboardPage = class DashboardPage {
    constructor(usuarioservicio, apiService, ruta, notificacion, alertController, loadingController) {
    ...
    ionViewDidEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const token = yield this.apiService.cargarToken();
            this.apiService.asignarToken(token);
            /* Este paso sere restructurado mas adelante */
            this.week = yield this.apiService.obtenerUsuario();
            //  EXAMEN CAPACIDAD
            this.capacidad = yield this.apiService.cargarExamenCapacidad();
            // fin de cargar
    ...
    nutricion() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const nutricion = yield this.apiService.cargarnutricion();
            //Validamos que exista el test home
            const comprobar = yield this.apiService.obtenerUsuario();
            if (validar == true) {
