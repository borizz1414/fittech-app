...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["alimentos-editar-alimentos-editar-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAlimentosEditarAlimentosEditarPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAlimentosEditarAlimentosEditarRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AlimentosEditarPageRoutingModule", function () {
      return AlimentosEditarPageRoutingModule;
    });
    /* harmony import */
    ...
    var _alimentos_editar_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./alimentos-editar.page */
    ...
    var AlimentosEditarPageRoutingModule = function AlimentosEditarPageRoutingModule() {
      _classCallCheck(this, AlimentosEditarPageRoutingModule);
    };

    AlimentosEditarPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppAlimentosEditarAlimentosEditarModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AlimentosEditarPageModule", function () {
      return AlimentosEditarPageModule;
    });
    /* harmony import */
    ...
    var _alimentos_editar_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./alimentos-editar-routing.module */
    "./src/app/alimentos-editar/alimentos-editar-routing.module.ts");
    /* harmony import */


    var _alimentos_editar_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./alimentos-editar.page */
    "./src/app/alimentos-editar/alimentos-editar.page.ts");
    /* harmony import */
    ...
    var AlimentosEditarPageModule = function AlimentosEditarPageModule() {
      _classCallCheck(this, AlimentosEditarPageModule);
    };

    AlimentosEditarPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _alimentos_editar_routing_module__WEBPACK_IMPORTED_MODULE_5__["AlimentosEditarPageRoutingModule"], _pipes_pipe_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]],
  ...
  /***/
  function srcAppAlimentosEditarAlimentosEditarPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAlimentosEditarAlimentosEditarPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AlimentosEditarPage", function () {
      return AlimentosEditarPage;
    });
    /* harmony import */
    ...
    var AlimentosEditarPage =
    /*#__PURE__*/
    function () {
      function AlimentosEditarPage(capturar, service, utilities, alertController, navCtrl) {
        _classCallCheck(this, AlimentosEditarPage);
      ...
      _createClass(AlimentosEditarPage, [{
        key: "ngOnInit",
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return this.service.ListadoComida(comida, this.today);
                  ...
                  case 8:
                    ...
                    if (valor == false) {
                      ...
                      console.log(valor);
                      this.alimentos = valor["Foods"]; // Compara si existe el registro y crea un registro dentro del array para identificar
                      // asigna de forma correcta si es casero o unidad

                      this.alimentos2.forEach(function (element) {
                        _this.alimentos.forEach(function (e) {
                          if (e.measure == null) {
          ...
          this.alimentos.forEach(function (element) {
            if (element.cantidad > 0) {
              if (element.measurement === "casera" && element.eq != null) {
                ...
                _this2.carbo += _this2.convertion(element.cant, element.carbo, element.cantidad * element.eq);
                _this2.grasa += _this2.convertion(element.cant, element.greases, element.cantidad * element.eq);
                _this2.protein += _this2.convertion(element.cant, element.protein, element.cantidad * element.eq);
              } else {
                _this2.carbo += _this2.convertion(element.cant, element.carbo, element.cantidad);
                _this2.grasa += _this2.convertion(element.cant, element.greases, element.cantidad);
                _this2.protein += _this2.convertion(element.cant, element.protein, element.cantidad);
                console.log(element);
        ...
        value: function calcularunidaIndividual(unidad, nombre, cant1, carbo1, grasa1, proteina1, cantidad1, eq1, alimento) {
          this.carbo2 = 0;
          this.grasas2 = 0;
          this.proteinas2 = 0;
                ...
                switch (_context2.prev = _context2.next) {
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          if (!menu.foods.length) {
                            _this3.utilities.alertaInformatica("Debe seleccionar un alimento");
                          } else {
                            _this3.service.ActualizarComida(menu).then(function (res) {
                              console.log(res);

                              _this3.utilities.notificacionUsuario(_this3.dataRecibida + " guardado", "dark");

                              _this3.navCtrl.navigateRoot("/bateria-alimento");
                            }).catch(function (err) {
                              _this3.utilities.alertaInformatica("Error al guardar " + _this3.dataRecibida);
                            });
                          }
                        }
                      }]
                  ...
                  case 10:
                    ...
                    if (!menu.foods.length) {
                      ...
                      this.service.ActualizarComida(menu).then(function (res) {
                        console.log(res);

                        _this3.utilities.notificacionUsuario(_this3.dataRecibida + " actualizado", "dark");

                        _this3.navCtrl.navigateRoot("/bateria-alimento");
                      }).catch(function (err) {
                        _this3.utilities.notificacionUsuario("Error al actualizar " + _this3.dataRecibida, "danger");
                      });
                    }
        ...
        value: function MenuAnterior() {
          ...
          this.service.storeMenu(menu).then(function (res) {
            ...
            _this5.utilities.alertaInformatica(_this5.dataRecibida + " Guardado");

            _this5.navCtrl.navigateRoot("/bateria-alimento");
          }).catch(function (err) {
            _this5.utilities.alertaInformatica("Error al guardar " + _this5.dataRecibida);
          });
        }
      }, {
        key: "info",
        value: function info(unidad, nombre, cant, carbo, grasa, proteina, cantidad, eq, alimento) {
          if (unidad == "gr") {
            unidad = "unidad";
          }
    ...
    AlimentosEditarPage.ctorParameters = function () {
      return [{
    ...
    AlimentosEditarPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-alimentos-editar",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./alimentos-editar.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/alimentos-editar/alimentos-editar.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./alimentos-editar.page.scss */
      "./src/app/alimentos-editar/alimentos-editar.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_nutricion_service__WEBPACK_IMPORTED_MODULE_3__["NutricionService"], _services_mensajes_service__WEBPACK_IMPORTED_MODULE_4__["MensajesService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"]])], AlimentosEditarPage);
    /***/
  }
}]);
//# sourceMappingURL=alimentos-editar-alimentos-editar-module-es5.js.map