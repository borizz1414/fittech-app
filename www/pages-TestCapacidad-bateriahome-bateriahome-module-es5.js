...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-TestCapacidad-bateriahome-bateriahome-module"], {
  ...
  /***/
  function node_modulesMugan86CronometroDistConstantsJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesMugan86CronometroDistContadorJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var conversion_1 = __webpack_require__(
    /*! ./conversion */
    ...
    function () {
      ...
      _createClass(Contador, [{
        ...
        value: function start() {
          ...
          return interval_1.interval(1000).pipe(map_1.map(function (x) {
            return conversion_1.convertirSGAFormatoReloj(x, 1, _this2.valorLimite);
          }));
        }
      }]);
  ...
  /***/
  function node_modulesMugan86CronometroDistConversionJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function convertirSGAFormatoReloj(tiempoSg, tipo, limite) {
      ...
      var horas = adaptToClockFormat(Math.floor(tiempoSg % constants_1.Tiempo.SG_DIA / constants_1.Tiempo.SG_HORA));
      var minutos = adaptToClockFormat(Math.floor(tiempoSg % constants_1.Tiempo.SG_HORA / constants_1.Tiempo.SG_MIN));
      var sg = adaptToClockFormat(Math.floor(tiempoSg % constants_1.Tiempo.SG_MIN));
      return "".concat(horas, ":").concat(minutos, ":").concat(sg);
    }
  ...
  /***/
  function node_modulesMugan86CronometroDistDescontadorJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
       ...
       * @param valor valor limite
       */
      function Descontador(valor) {
        _classCallCheck(this, Descontador);
      ...
      _createClass(Descontador, [{
        key: "start",
        value: function start() {
          var _this3 = this;

          return interval_1.interval(1000).pipe(map_1.map(function (x) {
            return conversion_1.convertirSGAFormatoReloj(_this3.valorInicial - x, 2, 1);
          }));
        }
      }]);
  ...
  /***/
  function node_modulesMugan86CronometroDistIndexJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTestCapacidadBateriahomeBateriahomePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTestCapacidadBateriahomeBateriahomeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BateriahomePageRoutingModule", function () {
      return BateriahomePageRoutingModule;
    });
    /* harmony import */
    ...
    var _bateriahome_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./bateriahome.page */
    ...
    var BateriahomePageRoutingModule = function BateriahomePageRoutingModule() {
      _classCallCheck(this, BateriahomePageRoutingModule);
    };

    BateriahomePageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesTestCapacidadBateriahomeBateriahomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BateriahomePageModule", function () {
      return BateriahomePageModule;
    });
    /* harmony import */
    ...
    var _bateriahome_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./bateriahome-routing.module */
    "./src/app/pages/TestCapacidad/bateriahome/bateriahome-routing.module.ts");
    /* harmony import */


    var _bateriahome_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./bateriahome.page */
    "./src/app/pages/TestCapacidad/bateriahome/bateriahome.page.ts");

    var BateriahomePageModule = function BateriahomePageModule() {
      _classCallCheck(this, BateriahomePageModule);
    };

    BateriahomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _bateriahome_routing_module__WEBPACK_IMPORTED_MODULE_5__["BateriahomePageRoutingModule"]],
  ...
  /***/
  function srcAppPagesTestCapacidadBateriahomeBateriahomePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTestCapacidadBateriahomeBateriahomePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BateriahomePage", function () {
      return BateriahomePage;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function BateriahomePage(capturar, ApiService, ruta, navCtrl) {
        _classCallCheck(this, BateriahomePage);
      ...
      _createClass(BateriahomePage, [{
        ...
        value: function atras() {
          if (this.actual < 1) {
            clearInterval(this.tiemposegundo); // this.navCtrl.pop();
          } else {
            clearInterval(this.tiemposegundo);
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    this.zero = null; // this.imagen = `http://fittech247.com/fittech/imagenes/${this.data['ejercicios Calentamiento'][this.actual].cod}/${this.data['ejercicios Calentamiento'][this.actual].id}.jpg`;

                    this.video2 = this.data[this.actual].url;
                    this.timeLeft = 5;
                    this.tiemposegundo = setInterval(function () {
                      if (_this6.timeLeft >= 1 && _this6.timeLeft < 10) {
                        _this6.playSonido(1);
                      }
        ...
        value: function finalizar() {
          // clearInterval(this.tiemposegundo);
          this.pauseTimer();
          this.navCtrl.navigateRoot("mensajecapacidad/".concat(this.actual));
    ...
    BateriahomePage.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('myVideo', {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], BateriahomePage.prototype, "txtVideo", void 0);
    BateriahomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-bateriahome',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./bateriahome.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/TestCapacidad/bateriahome/bateriahome.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./bateriahome.page.scss */
      "./src/app/pages/TestCapacidad/bateriahome/bateriahome.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], src_app_services_api_fitech_service__WEBPACK_IMPORTED_MODULE_2__["ApiFitechService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"]])], BateriahomePage);
    /***/
  }
}]);
//# sourceMappingURL=pages-TestCapacidad-bateriahome-bateriahome-module-es5.js.map