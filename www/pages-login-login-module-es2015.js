...
let LoginPage = class LoginPage {
    constructor(ApiService, ruta, mensajeservice, afAuth, gplus, fb, alertController, platform, storage, usuarioService, loadingController) {
    ...
    googleLogin() {
        this.gplus.login({}).then((response) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.presentLoading();
            const email = response.email;
            const name = response.displayName;
            const validar = yield this.ApiService.validarEmail(email);
            if (validar) {
    ...
    facebookLogin() {
        this.fb
            ...
            .then((res) => {
            this.fb
                .api("me?fields=id,name,email,first_name,picture.width(720).height(720).as(picture)", [])
                .then((profile) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                this.presentLoading();
    ...
    dashboard(valor) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const valido = yield this.ApiService.Login(valor);
            if (valido) {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: (data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                            const validar = yield this.ApiService.recuperarPassword(data);
                            if (validar) {
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_api_fitech_service__WEBPACK_IMPORTED_MODULE_2__["ApiFitechService"],
        ...
        src_app_services_usuario_service__WEBPACK_IMPORTED_MODULE_9__["UsuarioService"],
