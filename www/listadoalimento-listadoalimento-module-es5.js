...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["listadoalimento-listadoalimento-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppListadoalimentoListadoalimentoPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppListadoalimentoListadoalimentoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListadoalimentoPageRoutingModule", function () {
      return ListadoalimentoPageRoutingModule;
    });
    /* harmony import */
    ...
    var _listadoalimento_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./listadoalimento.page */
    ...
    var ListadoalimentoPageRoutingModule = function ListadoalimentoPageRoutingModule() {
      _classCallCheck(this, ListadoalimentoPageRoutingModule);
    };

    ListadoalimentoPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppListadoalimentoListadoalimentoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListadoalimentoPageModule", function () {
      return ListadoalimentoPageModule;
    });
    /* harmony import */
    ...
    var _listadoalimento_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./listadoalimento-routing.module */
    "./src/app/listadoalimento/listadoalimento-routing.module.ts");
    /* harmony import */


    var _listadoalimento_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./listadoalimento.page */
    "./src/app/listadoalimento/listadoalimento.page.ts");

    var ListadoalimentoPageModule = function ListadoalimentoPageModule() {
      _classCallCheck(this, ListadoalimentoPageModule);
    };

    ListadoalimentoPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _listadoalimento_routing_module__WEBPACK_IMPORTED_MODULE_5__["ListadoalimentoPageRoutingModule"]],
  ...
  /***/
  function srcAppListadoalimentoListadoalimentoPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppListadoalimentoListadoalimentoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListadoalimentoPage", function () {
      return ListadoalimentoPage;
    });
    /* harmony import */
    ...
    var ListadoalimentoPage =
    /*#__PURE__*/
    function () {
      function ListadoalimentoPage(capturar, service, utilities, fb, alertController, ruta) {
        _classCallCheck(this, ListadoalimentoPage);
      ...
      _createClass(ListadoalimentoPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {//  parametros del id
        }
      }, {
        key: "getFoods",
        ...
        value: function guardarMenu() {
          ...
          // borrar todo
          this.service.BorrarMenu(this.id).then(function (res) {
            // console.log(res);
            _this3.utilities.notificacionUsuario(_this3.dataRecibida + " actualizado", "dark");

            _this3.ruta.navigateRoot("/bateria-alimento");
          }).catch(function (err) {
            _this3.utilities.notificacionUsuario("Error al guardar " + _this3.dataRecibida, "danger");
          });
        }
      }, {
        key: "change",
        ...
        value: function agregar() {
          this.ruta.navigateForward(["/alimentos-editar/".concat(this.dataRecibida)]);
        }
      }]);
    ...
    ListadoalimentoPage.ctorParameters = function () {
      return [{
    ...
    ListadoalimentoPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-listadoalimento",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./listadoalimento.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/listadoalimento/listadoalimento.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./listadoalimento.page.scss */
      "./src/app/listadoalimento/listadoalimento.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_nutricion_service__WEBPACK_IMPORTED_MODULE_3__["NutricionService"], _services_mensajes_service__WEBPACK_IMPORTED_MODULE_4__["MensajesService"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"]])], ListadoalimentoPage);
    /***/
  }
}]);
//# sourceMappingURL=listadoalimento-listadoalimento-module-es5.js.map