...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["progreso-progreso-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProgresoProgresoPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProgresoProgresoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProgresoPageRoutingModule", function () {
      return ProgresoPageRoutingModule;
    });
    /* harmony import */
    ...
    var _progreso_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./progreso.page */
    ...
    var ProgresoPageRoutingModule = function ProgresoPageRoutingModule() {
      _classCallCheck(this, ProgresoPageRoutingModule);
    };

    ProgresoPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppProgresoProgresoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProgresoPageModule", function () {
      return ProgresoPageModule;
    });
    /* harmony import */
    ...
    var _progreso_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./progreso-routing.module */
    "./src/app/progreso/progreso-routing.module.ts");
    /* harmony import */


    var _progreso_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./progreso.page */
    "./src/app/progreso/progreso.page.ts");
    /* harmony import */
    ...
    var _modal_comparacion_modal_comparacion_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../modal-comparacion/modal-comparacion.page */
    "./src/app/modal-comparacion/modal-comparacion.page.ts");
    /* harmony import */


    var _modal_comparacion_modal_comparacion_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../modal-comparacion/modal-comparacion.module */
    "./src/app/modal-comparacion/modal-comparacion.module.ts");

    var ProgresoPageModule = function ProgresoPageModule() {
      _classCallCheck(this, ProgresoPageModule);
    };

    ProgresoPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      entryComponents: [_modal_comparacion_modal_comparacion_page__WEBPACK_IMPORTED_MODULE_8__["ModalComparacionPage"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _progreso_routing_module__WEBPACK_IMPORTED_MODULE_5__["ProgresoPageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _modal_comparacion_modal_comparacion_module__WEBPACK_IMPORTED_MODULE_9__["ModalComparacionPageModule"]],
  ...
  /***/
  function srcAppProgresoProgresoPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProgresoProgresoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProgresoPage", function () {
      return ProgresoPage;
    });
    /* harmony import */
    ...
    var _modal_comparacion_modal_comparacion_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../modal-comparacion/modal-comparacion.page */
    "./src/app/modal-comparacion/modal-comparacion.page.ts");
    /* harmony import */
    ...
    var _services_nutricion_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ProgresoPage(ruta, service, alertController, loadingController, modalController, utilities) {
        _classCallCheck(this, ProgresoPage);
      ...
      _createClass(ProgresoPage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    this.presentLoading();
                    _context.next = 3;
                    return this.service.historyMeasures();
        ...
        key: "segmentChanged",
        value: function segmentChanged(valor) {
        ...
        value: function buscador(valor, filtrar) {
          ...
          if (filtrar === "ante") {
            this.medidas_ante.imc = resultado.imc.toFixed(2), this.medidas_ante.ica = resultado.ica.toFixed(2), this.medidas_ante.min_waist = resultado.min_waist, this.medidas_ante.max_waist = resultado.max_waist, this.medidas_ante.hip = resultado.hip, this.medidas_ante.neck = resultado.neck, this.medidas_ante.right_thigh = resultado.right_thigh, this.medidas_ante.left_thigh = resultado.left_thigh, this.medidas_ante.right_arm = resultado.right_arm, this.medidas_ante.left_arm = resultado.left_arm, this.medidas_ante.right_arm_flexed = resultado.right_arm_flexed, this.medidas_ante.left_arm_flexed = resultado.left_arm_flexed, this.medidas_ante.right_calf = resultado.right_calf, this.medidas_ante.left_calf = resultado.left_calf, this.medidas_ante.torax = resultado.torax, this.medidas_ante.profile_photo = "".concat(this.URL, "/fotos/grasa/") + resultado.profile_photo, this.medidas_ante.front_photo = "".concat(this.URL, "/fotos/grasa/") + resultado.front_photo, this.medidas_ante.back_photo = "".concat(this.URL, "/fotos/grasa/") + resultado.back_photo;
          } else {
            this.medidas_despues.imc = resultado.imc.toFixed(2), this.medidas_despues.ica = resultado.ica.toFixed(2), this.medidas_despues.min_waist = resultado.min_waist, this.medidas_despues.max_waist = resultado.max_waist, this.medidas_despues.hip = resultado.hip, this.medidas_despues.neck = resultado.neck, this.medidas_despues.right_thigh = resultado.right_thigh, this.medidas_despues.left_thigh = resultado.left_thigh, this.medidas_despues.right_arm_flexed = resultado.right_arm_flexed, this.medidas_despues.right_arm = resultado.right_arm, this.medidas_despues.left_arm = resultado.left_arm, this.medidas_despues.left_arm_flexed = resultado.left_arm_flexed, this.medidas_despues.right_calf = resultado.right_calf, this.medidas_despues.left_calf = resultado.left_calf, this.medidas_despues.torax = resultado.torax, this.medidas_despues.profile_photo = "".concat(this.URL, "/fotos/grasa/") + resultado.profile_photo, this.medidas_despues.front_photo = "".concat(this.URL, "/fotos/grasa/") + resultado.front_photo, this.medidas_despues.back_photo = "".concat(this.URL, "/fotos/grasa/") + resultado.back_photo;
          }
        }
      }, {
        key: "presentAlert",
    ...
    ProgresoPage.ctorParameters = function () {
      return [{
    ...
    ProgresoPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-progreso',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./progreso.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/progreso/progreso.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./progreso.page.scss */
      "./src/app/progreso/progreso.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _services_nutricion_service__WEBPACK_IMPORTED_MODULE_6__["NutricionService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _services_mensajes_service__WEBPACK_IMPORTED_MODULE_5__["MensajesService"]])], ProgresoPage);
    /***/
  }
}]);
//# sourceMappingURL=progreso-progreso-module-es5.js.map