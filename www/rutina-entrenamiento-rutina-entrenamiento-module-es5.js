...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["rutina-entrenamiento-rutina-entrenamiento-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppRutinaEntrenamientoRutinaEntrenamientoPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRutinaEntrenamientoRutinaEntrenamientoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RutinaEntrenamientoPageRoutingModule", function () {
      return RutinaEntrenamientoPageRoutingModule;
    });
    /* harmony import */
    ...
    var _rutina_entrenamiento_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./rutina-entrenamiento.page */
    ...
    var RutinaEntrenamientoPageRoutingModule = function RutinaEntrenamientoPageRoutingModule() {
      _classCallCheck(this, RutinaEntrenamientoPageRoutingModule);
    };

    RutinaEntrenamientoPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppRutinaEntrenamientoRutinaEntrenamientoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RutinaEntrenamientoPageModule", function () {
      return RutinaEntrenamientoPageModule;
    });
    /* harmony import */
    ...
    var _rutina_entrenamiento_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./rutina-entrenamiento-routing.module */
    "./src/app/rutina-entrenamiento/rutina-entrenamiento-routing.module.ts");
    /* harmony import */


    var _rutina_entrenamiento_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./rutina-entrenamiento.page */
    "./src/app/rutina-entrenamiento/rutina-entrenamiento.page.ts");

    var RutinaEntrenamientoPageModule = function RutinaEntrenamientoPageModule() {
      _classCallCheck(this, RutinaEntrenamientoPageModule);
    };

    RutinaEntrenamientoPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _rutina_entrenamiento_routing_module__WEBPACK_IMPORTED_MODULE_5__["RutinaEntrenamientoPageRoutingModule"]],
  ...
  /***/
  function srcAppRutinaEntrenamientoRutinaEntrenamientoPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRutinaEntrenamientoRutinaEntrenamientoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RutinaEntrenamientoPage", function () {
      return RutinaEntrenamientoPage;
    });
    /* harmony import */
    ...
    var _rutinas_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../rutinas.service */
    ...
    var RutinaEntrenamientoPage =
    /*#__PURE__*/
    function () {
      function RutinaEntrenamientoPage(service, navCtrl, platform, alertController) {
        var _this = this;

        _classCallCheck(this, RutinaEntrenamientoPage);
        ...
        this.data = [];
        this.arraytemp = []; // SE SUBCRIBE CUANDO LA RUTINA ES PAUSADA
      ...
      _createClass(RutinaEntrenamientoPage, [{
        key: "ngOnInit",
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return this.service.getRutina();

                  case 2:
                    this.data = _context3.sent;
                    array1 = this.data['exercises'];
                    array1.forEach(function (element) {
                      if (element.side > 1) {
                        var objetoClonado = Object.assign({}, element);
                        objetoClonado.mostrar = 'derecha';
                        var objetoClonado2 = Object.assign({}, element);
                        objetoClonado2.mostrar = 'izquierda';

                        _this2.arraytemp.push(objetoClonado);

                        _this2.arraytemp.push(objetoClonado2);
                      } else {
                        _this2.arraytemp.push(element);
                      }
                    });
        ...
        value: function setValues() {
          ...
          this.rutinas = this.arraytemp.filter(function (value) {
            return value.stage === _this3.secuencia;
          });
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    this.video = "".concat(this.URL, "/videos/").concat(this.rutinas[this.actual].cod, "/").concat(this.rutinas[this.actual].url);
                    console.log(this.video);
                    this.mostrar = true;
                    this.timeLeft = this.data['ratio_w'];
                    b = setInterval(function () {
                      console.log(_this4.txtVideo.nativeElement.readyState);

                      if (_this4.txtVideo.nativeElement.readyState === 4) {
                        _this4.txtVideo.nativeElement.play();

                        _this4.ready = true; //cronometro
        ...
        value: function startTimer() {
          ...
          this.tiemposegundo = setInterval(function () {
            if (_this5.timeLeft <= 10) {
              console.log("activate");
              _this5.zero = 0;
            }

            if (_this5.timeLeft === 1) {
              _this5.playSonido(2);
            }

            if (_this5.timeLeft > 1 && _this5.timeLeft <= 5) {
              _this5.playSonido(1);
            }
            ...
            if (_this5.timeLeft > 0) {
              ...
              _this5.txtVideo.nativeElement.pause();
            }
          }, 1000);
        }
      }, {
        ...
        key: "playSonido",
        value: function playSonido(valor) {
        ...
        key: "timerDescanse",
        value: function timerDescanse() {
          var timerContinue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    this.zero = null; // this.imagen = `${this.URL}/imagenes/${this.rutinas[this.actual].cod}/${this.rutinas[this.actual].id}.jpg`;

                    this.video2 = "".concat(this.URL, "/videos/").concat(this.rutinas[this.actual].cod, "/").concat(this.rutinas[this.actual].url);
                    ...
                    this.tiemposegundo = setInterval(function () {
                      if (_this6.timeLeft <= 10) {
                        console.log("activate");
                        _this6.zero = 0;
                      }

                      if (_this6.timeLeft >= 1 && _this6.timeLeft < 5) {
                        _this6.playSonido(1);
                      }
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          clearInterval(_this7.tiemposegundo);
                          _this7.timeLeft = -1;

                          _this7.navCtrl.navigateRoot("tabs/dashboard");
                        }
                      }]
                    });
                  ...
                  case 0:
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        cssClass: 'cancelButton',
                        handler: function handler(blah) {
                          _this8.timerDescanse(_this8.timeLeft);
                        }
                      }, {
                        text: 'Finalizar',
                        cssClass: 'confirmButton',
                        handler: function handler() {
                          _this8.navCtrl.navigateRoot("tabs/dashboard");
                        }
                      }]
                    });
                  ...
                  case 0:
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        cssClass: 'confirmButton',
                        handler: function handler() {
                          clearInterval(_this10.tiemposegundo);

                          _this10.navCtrl.navigateRoot("tabs/dashboard");
                        }
                      }]
                    });
    ...
    RutinaEntrenamientoPage.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('myVideo', {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], RutinaEntrenamientoPage.prototype, "txtVideo", void 0);
    RutinaEntrenamientoPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-rutina-entrenamiento',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./rutina-entrenamiento.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/rutina-entrenamiento/rutina-entrenamiento.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./rutina-entrenamiento.page.scss */
      "./src/app/rutina-entrenamiento/rutina-entrenamiento.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_rutinas_service__WEBPACK_IMPORTED_MODULE_2__["RutinasService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"]])], RutinaEntrenamientoPage);
    /***/
  }
}]);
//# sourceMappingURL=rutina-entrenamiento-rutina-entrenamiento-module-es5.js.map